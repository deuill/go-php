...
var valueNewTests = []struct {
	...
	{[]string{"Knick", "Knack"}, []interface{}{"Knick", "Knack"}},
	{[][]string{{"1", "2"}, {"3"}}, []interface{}{[]interface{}{"1", "2"}, []interface{}{"3"}}},
	{map[string]int{"biggs": 23, "wedge": 16}, map[string]interface{}{"biggs": int64(23), "wedge": int64(16)}},
	{map[int]string{10: "this", 20: "that"}, map[string]interface{}{"10": "this", "20": "that"}},
	{struct {
		I int
		S string
		B bool
		h string
	}{66, "wow", true, "hidden"}, map[string]interface{}{"I": int64(66), "S": "wow", "B": true}},
}
...
var valueKindTests = []struct {
	...
	{true, Bool},
	{"Hello World", String},
	{[]string{"Knick", "Knack"}, Array},
	{map[string]int{"t": 1, "c": 2}, Map},
	{struct {
		I int
		S string
	}{66, "wow"}, Object},
...
var valueIntTests = []struct {
	...
	{true, int64(1)},
	{"Hello World", int64(0)},
	{[]string{"Knick", "Knack"}, int64(1)},
	{map[string]int{"t": 1, "c": 2}, int64(1)},
	{struct {
		I int
		S string
	}{66, "wow"}, int64(1)},
...
var valueFloatTests = []struct {
	...
	{3.14159, float64(3.14159)},
	{true, float64(1)},
	{"Hello World", float64(0)},
	{[]string{"Knick", "Knack"}, float64(1)},
	{map[string]int{"t": 1, "c": 2}, float64(1)},
	{struct {
		I int
		S string
	}{66, "wow"}, float64(1)},
...
var valueBoolTests = []struct {
	...
	{true, true},
	{"Hello World", true},
	{[]string{"Knick", "Knack"}, true},
	{map[string]int{"t": 1, "c": 2}, true},
	{struct {
		I int
		S string
	}{66, "wow"}, true},
...
var valueSliceTests = []struct {
	...
	{3.14159, []interface{}{float64(3.14159)}},
	{true, []interface{}{true}},
	{"Hello World", []interface{}{"Hello World"}},
	{[]string{"Knick", "Knack"}, []interface{}{"Knick", "Knack"}},
	{map[string]int{"t": 1, "c": 2}, []interface{}{int64(1), int64(2)}},
	{struct {
		I int
		S string
	}{66, "wow"}, []interface{}{int64(66), "wow"}},
}
...
var valueMapTests = []struct {
	...
	{42, map[string]interface{}{"0": int64(42)}},
	{3.14159, map[string]interface{}{"0": float64(3.14159)}},
	{true, map[string]interface{}{"0": true}},
	{"Hello World", map[string]interface{}{"0": "Hello World"}},
	{[]string{"Knick", "Knack"}, map[string]interface{}{"0": "Knick", "1": "Knack"}},
	{map[string]int{"t": 1, "c": 2}, map[string]interface{}{"t": int64(1), "c": int64(2)}},
	{struct {
		I int
		S string
	}{66, "wow"}, map[string]interface{}{"I": int64(66), "S": "wow"}},
}
